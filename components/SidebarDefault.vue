<template>
    <div>
        <aside
            ...
            enter-active-class-start="opacity-0 transform -translate-x-20"
            enter-active-class-end="opacity-100"
            leave-active-class="transition ease-in-out duration-150"
            leave-active-class-start="opacity-100"
            leave-active-class-end="opacity-0 transform -translate-x-20"
            class="z-20 fixed md:relative inset-y-0 mt-16 md:mt-0 flex-shrink-0 w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block lg:block duration-150"
        ...
        >
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul class="mt-6">
                    ...
                    <li class="relative px-6 py-3">
                        <button class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" aria-haspopup="true" @click="togglePagesMenu">
                        ...
                        <template v-if="isPagesMenuOpen">
                            <ul
                                ...
                                enter-active-class-start="opacity-25 max-h-0"
                                enter-active-class-end="opacity-100 max-h-xl"
                                leave-active-class="transition-all ease-in-out duration-300"
                                leave-active-class-start="opacity-100 max-h-xl"
                                leave-active-class-end="opacity-0 max-h-0"
        ...
        <div
            ...
            enter-active-class="transition ease-in-out duration-150"
            enter-active-class-start="opacity-0"
            enter-active-class-end="opacity-100"
            leave-active-class="transition ease-in-out duration-150"
            leave-active-class-start="opacity-100"
            leave-active-class-end="opacity-0"
