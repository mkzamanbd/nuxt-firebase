                    ...
                    <div class="w-full">
                        ...
                        <label class="block text-sm">
                            ...
                            <input
                                ...
                                class="block w-full mt-1 text-sm border rounded appearance-none p-2 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        ...
                        <button
                            type="submit"
                            :disabled="isLoading"
                            class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-purple"
                            :class="{ 'disabled:opacity-100 cursor-not-allowed': isLoading }"
                        >
                            Log in
                        </button>
